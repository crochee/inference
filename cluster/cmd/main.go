...
import (
	...
	termcontroller "cluster/internal/controller/term"
...
func init() {
	...
	utilruntime.Must(termv1.AddToScheme(scheme))
...
func Operator(ctx context.Context) error {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "bfc1474d.cts.io",
	...
	if err := (&termcontroller.CloudTermReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("CloudTerm-Controller"),
		Tracer:   otel.Tracer("CloudTerm-Controller"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CloudTerm")
		return err
	}
